...
const footerNavigation = {
  company: [
    ...
    { name: 'Blog', href: ROUTE_MAP.app.blog },
  ...
  contractors: [
    { name: 'Learn More', href: ROUTE_MAP.app.contractors },
    { name: 'FAQ', href: ROUTE_MAP.app.faq },
  ],
  legal: [
    { name: 'Privacy Policy', href: ROUTE_MAP.app.privacy },
    { name: 'Terms of Service', href: ROUTE_MAP.app.tos },
  ],
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/remodelmate',
      icon: (props: any) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/remodelmate',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'Twitter',
      href: 'https://www.twitter.com/remodelmate',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/channel/UCjCj_WIhM3FVA8sr0kOAXSQ',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
