...
import { XIcon, MenuAlt3Icon, SearchIcon, ShoppingBagIcon, InboxIcon, SparklesIcon } from '@heroicons/react/outline'
  ...
  return (
    <div className="bg-white">
      ...
      <main>
        ...
        <section aria-labelledby="alternating-feature-sections-heading" className="relative">
