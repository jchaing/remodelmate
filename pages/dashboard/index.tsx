...
const Dashboard = () => {
  const projects = [
    {
      _id: '620be8b99e22ea0009dd277f',
      name: 'Project 1',
      address: {
        street: '123 Los Alamitos St',
        city: 'San Francisco',
        state: 'CA',
        zip: '94105',
      },
      ...
      <>
        <div className="mt-5 sm:flex sm:items-center">
          ...
          {/* <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
            <Link href="/estimate/1" legacyBehavior>
              <button
                type="button"
                className="btn-sm btn rounded-md border border-transparent bg-indigo-600 font-normal hover:bg-indigo-900"
              >
                New Estimate
              </button>
            </Link>
